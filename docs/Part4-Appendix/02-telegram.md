...
> 스킬에 대한 자세한 내용은 [고급 기능 가이드](./01_Advanced_Features.md)를 참고하세요.
...
- **tmux와 함께 사용**: [tmux 가이드](./03_Tmux_and_Agent_Teams.md)의 tmux 설정과 함께 사용하면 Claude Code 세션을 백그라운드로 유지하면서 텔레그램으로 지시 가능
