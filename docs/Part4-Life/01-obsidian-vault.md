...
nlm CLI 설치가 필요합니다. 자세한 설치 방법은 [NotebookLM CLI 연동 가이드](../Part3-Research/01-notebooklm.md)를 참고하세요.
...
> **Tip:** Gmail MCP를 연동하면 뉴스레터도 같은 피드 노트에 통합할 수 있습니다. 추천 뉴스레터 목록은 [부록](../Part5-Appendix/)을 참고하세요.
...
*(작성 예정 — [학술 논문 쓰기](../Part3-Research/04-paper-writing.md) 가이드와 연계)*
...
- [학술 논문 쓰기](../Part3-Research/04-paper-writing.md) — LaTeX + CLAUDE.md로 논문 작성 (이 가이드의 연구 노트와 연계)
